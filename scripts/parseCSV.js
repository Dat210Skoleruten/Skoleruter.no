...
function parseData(callback) {
    if (Session.get("schoolRoutes") == null) {
        ...
        url = UrlExists("https://open.stavanger.kommune.no/dataset/86d3fe44-111e-4d82-be5a-67a9dbfbfcbb/resource/21cfc45a-d2bf-448a-a883-210ee4a96d9a/download/skolerute.csv") ? "https://open.stavanger.kommune.no/dataset/86d3fe44-111e-4d82-be5a-67a9dbfbfcbb/resource/21cfc45a-d2bf-448a-a883-210ee4a96d9a/download/skolerute.csv" : "https://skoleruter.azurewebsites.net/skolerute-2016-17.csv";
...
function parseSecondData(callback) {
    if (Session.get("schools") == null) {
        ...
        url = UrlExists("https://open.stavanger.kommune.no/dataset/8f8ac030-0d03-46e2-8eb7-844ee11a6203/resource/12f0d499-6474-4fe4-b457-db976e52cb37/download/skoler.csv") ? "https://open.stavanger.kommune.no/dataset/8f8ac030-0d03-46e2-8eb7-844ee11a6203/resource/12f0d499-6474-4fe4-b457-db976e52cb37/download/skoler.csv" : "https://skoleruter.azurewebsites.net/skoler.csv";
